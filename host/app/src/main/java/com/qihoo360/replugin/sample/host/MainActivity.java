...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_start_demo3).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 若没有安装，则直接提示“错误”
                // TODO 将来把回调串联上
                if (RePlugin.isPluginInstalled("MyPatchDemo")) {
                    RePlugin.startActivity(MainActivity.this, RePlugin.createIntent("MyPatchDemo", "com.plugin.re.myrepluginapplication.LanucherActivity"));
                } else {
    ...
    private void simulateInstallExternalPlugin() {
        ...
        Log.i("Lys",info.getApkDir()+"\n"+info.getName()+"\n"+info.getAlias()+"\n"+info.toString());

        if (info != null) {
            RePlugin.startActivity(MainActivity.this, RePlugin.createIntent(info.getName(), "com.plugin.re.myrepluginapplication.LanucherActivity"));
        }else {
